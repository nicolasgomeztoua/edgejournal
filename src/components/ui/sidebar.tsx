...
function Sidebar({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					...
					variant === "floating" || variant === "inset"
						...
						: "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l border-sidebar-border/60",
					className,
				)}
			...
			>
				<div
					className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border/70 group-data-[variant=floating]:bg-sidebar/70 group-data-[variant=floating]:backdrop-blur-xl group-data-[variant=floating]:shadow-lg group-data-[variant=floating]:shadow-black/20"
					data-sidebar="sidebar"
