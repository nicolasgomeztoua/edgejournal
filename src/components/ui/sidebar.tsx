...
function Sidebar({
	...
	return (
		...
		>
			...
			>
				<div
					className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border/70 group-data-[variant=floating]:bg-sidebar/70 group-data-[variant=floating]:shadow-black/20 group-data-[variant=floating]:shadow-lg group-data-[variant=floating]:backdrop-blur-xl"
					data-sidebar="sidebar"
