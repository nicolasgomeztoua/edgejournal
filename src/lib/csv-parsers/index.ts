 ...
 */
export function getSupportedPlatforms(): { value: TradingPlatform; label: string; description: string }[] {
	return [
		{ value: "mt4", label: "MetaTrader 4", description: "MT4 history export" },
		{ value: "mt5", label: "MetaTrader 5", description: "MT5 history export" },
		{ value: "projectx", label: "ProjectX", description: "ProjectX platform export" },
